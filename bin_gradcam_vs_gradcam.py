...
for idx in random_indices:
    ...
    attr_gc_bin_w_bn = layer_gc_bin_w_bn.attribute(x, target=pred)
    ...
    plt.tight_layout()
    import os 
    if not os.path.exists("bin_gradcam_vs_proposed"):
        os.makedirs("bin_gradcam_vs_proposed")
    plt.savefig(f"bin_gradcam_vs_proposed/{idx}.png", bbox_inches="tight", dpi=150)
    plt.close()
