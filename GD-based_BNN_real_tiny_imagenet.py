...
transform = transforms.Compose([
        transforms.Resize(224),   # 升到 224×224
        transforms.ToTensor(),
        transforms.Normalize(**__imagenet_stats),
    ])
# train / val 資料夾
val_dir = "/home/aesop/BNN/Gradient_based/BinaryNet.pytorch/Datasets/tiny-imagenet-200/val/val_split"  # 重新整理過的 validation
...
model_config = {'input_size': 224, 'dataset': "imagenet"}
model = model(**model_config)
checkpoint = torch.load("/home/aesop/BNN/Gradient_based/BinaryNet.pytorch/results/2025-09-05_22-55-30/model_best.pth.tar")
...
for idx in range(5):
    ...
    mean_img = mean.expand(1, 3, 224, 224).to("cuda")
    ...
    attr_gc = F.interpolate(attr_gc, size=(224, 224), mode='bilinear', align_corners=False)
...
plt.tight_layout()
plt.savefig("attribution_results_real_tiny_imagenet.png")