...
# I think this is a bug. When setting to "auto", MostRelevantFirst and Least is opposite.
# So I just fix it here by swapping the two.
cam_metric = ROADMostRelevantFirst(percentile="auto")
...
for idx in range(len(dataset)):
    ...
    drop_in_confidence_cam = drop_in_confidence(cam_scores, pred, y, model)
    increase_in_confidence_cam = increase_in_confidence(cam_scores, pred, y, model)
    ...
    drop_in_confidence_cam_plus = drop_in_confidence(cam_plus_scores, pred, y, model)
    increase_in_confidence_cam_plus = increase_in_confidence(cam_plus_scores, pred, y, model)
    ...
    drop_in_confidence_score_cam = drop_in_confidence(score_cam_scores, pred, y, model)
    increase_in_confidence_score_cam = increase_in_confidence(score_cam_scores, pred, y, model)
    ...
    drop_in_confidence_sign_cam = drop_in_confidence(sign_cam_scores, pred, y, model)
    increase_in_confidence_sign_cam = increase_in_confidence(sign_cam_scores, pred, y, model)
    
    drop_cam.append(drop_in_confidence_cam)
    increase_cam.append(increase_in_confidence_cam)
    drop_cam_plus.append(drop_in_confidence_cam_plus)
    increase_cam_plus.append(increase_in_confidence_cam_plus)
    drop_score_cam.append(drop_in_confidence_score_cam)
    increase_score_cam.append(increase_in_confidence_score_cam)
    drop_sign_cam.append(drop_in_confidence_sign_cam)
    increase_sign_cam.append(increase_in_confidence_sign_cam)


    # import os
    # if not os.path.exists(f"ROAD_auto_image/{idx}_{label}_{pred}"):
    #     os.makedirs(f"ROAD_auto_image/{idx}_{label}_{pred}")
    ...
    # plt.axis("off")
    # plt.savefig(f"ROAD_auto_image/{idx}_{label}_{pred}/original.png", bbox_inches="tight", dpi=500)
    # plt.close()
    ...
    # plt.axis("off")
    # plt.savefig(f"ROAD_auto_image/{idx}_{label}_{pred}/gradcam.png", bbox_inches="tight", dpi=500)
    # plt.close()
    ...
    # plt.axis("off")
    # plt.savefig(f"ROAD_auto_image/{idx}_{label}_{pred}/gradcam_visualization.png", bbox_inches="tight", dpi=500)
    # plt.close()
    ...
    # plt.axis("off")
    # plt.savefig(f"ROAD_auto_image/{idx}_{label}_{pred}/gradcam_plus.png", bbox_inches="tight", dpi=500)
    # plt.close()
    ...
    # plt.axis("off")
    # plt.savefig(f"ROAD_auto_image/{idx}_{label}_{pred}/gradcam_plus_visualization.png", bbox_inches="tight", dpi=500)
    # plt.close()
    ...
    # plt.axis("off")
    # plt.savefig(f"ROAD_auto_image/{idx}_{label}_{pred}/scorecam.png", bbox_inches="tight", dpi=500)
    # plt.close()
    ...
    # plt.axis("off")
    # plt.savefig(f"ROAD_auto_image/{idx}_{label}_{pred}/scorecam_visualization.png", bbox_inches="tight", dpi=500)
    # plt.close()
    ...
    # plt.axis("off")
    # plt.savefig(f"ROAD_auto_image/{idx}_{label}_{pred}/signcam.png", bbox_inches="tight", dpi=500)
    # plt.close()
    ...
    # plt.axis("off")
    # plt.savefig(f"ROAD_auto_image/{idx}_{label}_{pred}/signcam_visualization.png", bbox_inches="tight", dpi=500)
    # plt.close()

print("road_auto results:")
